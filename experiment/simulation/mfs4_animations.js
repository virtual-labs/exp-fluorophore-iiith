...
function movePipette() {
        if(step_no == 2 && count == 2){
            ...
            if(sol_name == 0||sol_name == 1||sol_name == 2||sol_name == 3){
                elem.src = "images/pipette-with-blue-sol.png";
                $("#round-bottom-flask").attr("src", "images/half-filled-blue-sol.png");
            }
            else{
                elem.src = "images/pipette-with-yellow-sol.png";
                $("#round-bottom-flask").attr("src", "images/half-filled-yellow-sol.png");
            }
            ...
            if(sol_name == 0||sol_name == 1||sol_name == 2||sol_name == 3){
                $("#quartz_cuvette").attr("src", "images/quartz-cuv-with-blue-sol.png");
            }
            else{
                $("#quartz_cuvette").attr("src", "images/quartz-cuv-with-yellow-sol.png");
            }
            step_no ++;
            setTimeout(function(){ 
                movebackPipette();
